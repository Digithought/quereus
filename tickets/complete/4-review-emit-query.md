...
Ticket: tickets/fix/3-remote-query-vtable-disconnect.md
...
Ticket: tickets/fix/2-window-function-emitter-stale-counter.md
...
Ticket: tickets/plan/2-window-ranking-quadratic-perf.md (pre-existing)
...
Ticket: tickets/plan/2-deduplicate-aggregate-node-classes.md (related — emitter dedup would naturally follow node dedup)
