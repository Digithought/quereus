...
Ticket: tickets/fix/3-set-operation-isSet-and-except-dedup.md
...
Ticket: tickets/fix/2-view-reference-node-type-defaults.md
...
Ticket: tickets/fix/3-remote-query-vtable-disconnect.md (pre-existing)
