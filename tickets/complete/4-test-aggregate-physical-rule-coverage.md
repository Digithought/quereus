...
Remaining uncovered branches (3) are unreachable via SQL with current cost constants and engine behavior. A follow-up ticket was filed: `tickets/plan/3-dead-sort-stream-aggregate-branch.md`.
