...
export const manifest = {
  ...
  version: '1.0.0',
  author: 'Quereus Team',
  description: 'Custom collation functions for specialized sorting behaviors',
  provides: {
 ...
 */
function alphanumCollation(a, b) {
  const tokenize = (str) => {
    const tokens = [];
    let i = 0;
 ...
 */
function phoneticCollation(a, b) {
  const normalize = (str) => {
