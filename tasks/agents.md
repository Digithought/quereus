...
- Implement - These tasks are ready for implementation.  If more than one agent would be useful, without stepping on toes, spawn sub-agents.  Once complete, output a distilled summary of the task, with emphasis on testing, validation and usage into the /review folder and delete the task from /implement
